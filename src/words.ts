...
export function getWordOfTheDay() {
  ...
  return common3LetterWords.sort(() => 0.5 - Math.random())[0];
/*
  const now = new Date()
...
export const allWords = [...common3LetterWords, ...allowedGuesses, ...all3LetterWords]
